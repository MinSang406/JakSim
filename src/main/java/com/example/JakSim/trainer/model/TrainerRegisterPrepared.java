...
public class TrainerRegisterPrepared implements PreparedStatementCreator {
    private TrainerDo trainerDo;
    private String[] keyColumns;
    private String sql;


    public TrainerRegisterPrepared(TrainerDo trainerDo, String[] keyColumns, String sql){
        this.trainerDo = trainerDo;
        this.keyColumns = keyColumns;
        this.sql = sql;
    }
    public TrainerRegisterPrepared(TrainerDo trainerDo, String sql){
